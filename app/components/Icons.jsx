export function Spark({ classes }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      className={`size-4 ${classes}`}
    >
      <defs>
...
export function EditIcon({ classes }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function DeleteIcon({ classes }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function PlusIcon({ classes }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function DownArrowIcon({ classes }) {
  return (
    <svg className={`size-6 ${classes}`} viewBox="0 0 532 532">
      <path
        fill="currentColor"
...
export function UpArrowIcon({ classes }) {
  return (
    <svg className={`size-6 ${classes}`} viewBox="0 0 532 532">
      <path
        fill="currentColor"
